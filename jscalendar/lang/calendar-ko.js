...
"��¥ ����:\n" +
"- ������ �����Ϸ��� \xab, \xbb ��ư�� ����մϴ�\n" +
"- ���� �����Ϸ��� " + String.fromCharCode(0x2039) + ", " + String.fromCharCode(0x203a) + " ��ư�� �(c)������\n" +
"- ��� �(c)���� ������ �� ������ ������ �����Ͻ� �� �ֽ��ϴ�.";
...
Calendar._TT["PREV_YEAR"] = "���� �� (��� �(c)���� ���)";
Calendar._TT["PREV_MONTH"] = "���� �� (��� �(c)���� ���)";
Calendar._TT["GO_TODAY"] = "���� ��¥��";
Calendar._TT["NEXT_MONTH"] = "���� �� (��� �(c)���� ���)";
Calendar._TT["NEXT_YEAR"] = "���� �� (��� �(c)���� ���)";
